...
public class G {
    ...
    public static class V implements Serializable{
        ...
        public static class Transform{
            ...
            public void setScale(int oW, int oH, int nW, int nH){
                //old width ---> new coordinates
                // max old w or h divides new w or h ---> n/d
                n = (nW > nH) ? nW : nH;
                d = (oW > oH) ? oW : oH;//select the bigger one
            }
    ...
    public static class VS {
        ...
        public void fill(Graphics g, Color c){ //helper class
    ...
    public static class LoHi {
        ...
        public int size(){return (hi - lo) == 0 ? 1 : (hi - lo);} //conditional boolean value
        // if ()==x is true, return the value after ?, if not return the value after :
    ...
    public static class BBox {
        ...
        public void add(V v){h.add(v.x); this.v.add(v.y);} //this.v from LoHi
        public void add(int x , int y){h.add(x); v.add(y);}
        public VS getNewVS(){return new VS(h.lo, v.lo, h.size(), v.size());} //create data
